  ...
  while (true) {
    ...
    if (f_tckr50ms == true) {
      ...
      if (sc1 == 1) {
        ...
        char22Arr(48 + sek12, 4, y3);
        char22Arr(48 + sek11, 4, y + y1);
        if (y == 0) {
          sc1 = 0;
          f_scrollend_y = true;
        }
        ...
        char22Arr(48 + sek1, 4, 0);

      if (sc2 == 1) {
        char22Arr(48 + sek22, 8, y3);
        char22Arr(48 + sek21, 8, y + y1);
        if (y == 0)
          sc2 = 0;
      }
      else
        char22Arr(48 + sek2, 8, 0);

      if (sc3 == 1) {
        char2Arr(48 + min12, 14, y3);
        char2Arr(48 + min11, 14, y + y1);
        if (y == 0)
          sc3 = 0;
      }
      else
        char2Arr(48 + min1, 14, 0);

      if (sc4 == 1) {
        char2Arr(48 + min22, 19, y3);
        char2Arr(48 + min21, 19, y + y1);
        if (y == 0)
          sc4 = 0;
      }
      else
        char2Arr(48 + min2, 19, 0);

      if (sc5 == 1) {
        char2Arr(48 + std12, 27, y3);
        char2Arr(48 + std11, 27, y + y1);
        if (y == 0)
          sc5 = 0;
      }
      else
        char2Arr(48 + std1, 27, 0);

      if (sc6 == 1) {
        char2Arr(48 + std22, 32, y3);
        char2Arr(48 + std21, 32, y + y1);
        if (y == 0)
          sc6 = 0;
      }
      else
        char2Arr(48 + std2, 32, 0);
